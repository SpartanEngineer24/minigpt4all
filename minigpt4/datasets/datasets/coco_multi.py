...
class COCOMultilingual(Dataset):
    def __init__(self, vis_processor, text_processor, vis_root, ann_path):
        ...
        self.instruction_pool = [
            '<Img><ImageHere></Img> Given the image, generate an answer the following question: {}',
            '<Img><ImageHere></Img> Based on the image, answer the question: {}',
            '<Img><ImageHere></Img> Given the visual representation, provide an answer to this question: "{}"',
            '<Img><ImageHere></Img> From the image provided, reply the following inquiry: {}',
            '<Img><ImageHere></Img> Considering the picture, come up with a response to the inquiry: {}',
            '<Img><ImageHere></Img> Taking the image into account, answer this inquiry: {}'
        ]
    ...
    def __getitem__(self, idx):
        ...
        question = random.choice(self.instruction_pool).format(question)
